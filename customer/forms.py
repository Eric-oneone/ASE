...
class CustomerForm(forms.Form):
    ...
    name = forms.CharField(label='Client name', max_length=32, widget=forms.TextInput(attrs={'class': 'form-control'}))
    phone = forms.CharField(label='telephone', validators=[phone_validate, ], max_length=11,
